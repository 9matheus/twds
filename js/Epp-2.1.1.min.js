...
$('.header .function .menus .func .share .cont').click(function() {
    $('.share-slide').fadeIn();
})
$('.header .function .menus .func .share .share-slide .box').click(function() {
    var src = $(this).find('img').attr('src');
    $('.header .function .menus .func .share .cont .imgs img').attr('src', src);
    $('.share-slide').hide();
})
$('.header .function .menus .func .share').hover(function() {

}, function() {
    $('.share-slide').hide();
})

$('.header .function .menus .func .countries .cont').click(function() {
    $('.countries-slide').fadeIn();
})
$('.header .function .menus .func .countries .countries-slide .box').click(function() {
    var src = $(this).find('img').attr('src');
    $('.header .function .menus .func .countries .cont .imgs img').attr('src', src);
    $('.countries-slide').hide();
})
$('.header .function .menus .func .countries').hover(function() {
